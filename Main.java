...
class Main {
    public static void main(String[] args) {
        System.out.println("Введите 2 числа и знак между ними. ");
        System.out.println("Числа от 1 до 10, либо от I до X");
        ...
        if ((words.length == 1) || (words.length == 2)) {
            ...
            throw new IndexOutOfBoundsException("throws Exception //т.к. строка не является математической операцией");

        }
        if (words.length > 3) {
            System.out.println("throws Exception //т.к. формат математической операции не удовлетворяет заданию - два операнда и один оператор (+, -, /, *)");
            throw new IndexOutOfBoundsException("throws Exception //т.к. формат математической операции не удовлетворяет заданию - два операнда и один оператор (+, -, /, *)");
        }
        ...
        if ((tok1.equals("1")) || (tok1.equals("2")) || (tok1.equals("3")) || (tok1.equals("4")) || (tok1.equals("5")) || (tok1.equals("6")) || (tok1.equals("7")) || (tok1.equals("8")) || (tok1.equals("9")) || (tok1.equals("10"))) {
            ...
            throw new IndexOutOfBoundsException("throws Exception // заданно не верное число");
        }
        ...
        if (!tok1_lang.equals(tok3_lang)) {
            ...
            throw new IndexOutOfBoundsException("throws Exception //т.к. используются одновременно разные системы счисления");
        }
        ...
        switch (tok2_1) {
            ...
            case "/" -> i1 = tok1_int / tok3_int;
            default -> {
                System.out.println("throws Exception // допустимые арифметические операции: +, -, *, /.");
                throw new IndexOutOfBoundsException("throws Exception // допустимые арифметические операции: +, -, *, /.");
            }
        }
        ...
        if (tok1_lang.equals("rim") && (i2 < 1)) {
            ...
            throw new IndexOutOfBoundsException("throws Exception //т.к. в римской системе нет отрицательных чисел");
        }
